...
app.get('/docs', (req, res) => {
    res.send(`<!DOCTYPE html><html><head><script src="https://cdn.tailwindcss.com"></script></head><body class="bg-[#020617] text-white p-10">
    <h1 class="text-sky-400 font-black text-3xl mb-8 tracking-tighter italic">API DOCUMENTATION</h1>
    <div class="grid gap-4">
        <div class="bg-white/5 p-6 rounded-3xl border border-white/10"><code>GET /ai/gemini?text=halo</code></div>
        <div class="bg-white/5 p-6 rounded-3xl border border-white/10"><code>GET /search/tiktok?q=query</code></div>
        <div class="bg-white/5 p-6 rounded-3xl border border-white/10"><code>GET /information/cuaca?kota=jakarta</code></div>
        <div class="bg-white/5 p-6 rounded-3xl border border-white/10"><code>GET /sholat/1301</code></div>
    </div>
    <a href="/" class="block mt-10 text-slate-500 font-bold">← BACK TO DASHBOARD</a>
    </body></html>`);
});
