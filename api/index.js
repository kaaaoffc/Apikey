...
app.get('/tools/qrcode', async (req, res) => {
    ...
    if (!text) return res.send("Masukkan query! Contoh: /tools/qrcode?text=KaaaOffc");
    try {
        ...
        <body style="background:#020617;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;margin:0;font-family:sans-serif;">
            <div style="background:white;padding:25px;border-radius:40px;box-shadow:0 0 60px rgba(56,189,248,0.4);">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6 mb-10 text-center">
                <div class="bg-slate-900/50 p-8 rounded-[40px] border border-white/5">
                    ...
                    <p class="text-[10px] text-slate-500 uppercase mt-2 font-bold tracking-widest">Requests</p>
                </div>
                <div class="bg-slate-900/50 p-8 rounded-[40px] border border-white/5">
                    <p class="text-4xl font-black text-white">48.91 GB</p>
                    <p class="text-[10px] text-slate-500 uppercase mt-2 font-bold tracking-widest">Memory</p>
                </div>
                <div class="bg-slate-900/50 p-8 rounded-[40px] border border-white/5">
                    <p class="text-4xl font-black text-emerald-400">ONLINE</p>
                    <p class="text-[10px] text-slate-500 uppercase mt-2 font-bold tracking-widest">Status</p>
                </div>
            </div>
...
app.get('/verify', (req, res) => {
    res.send('<body style="background:#020617;display:flex;align-items:center;justify-content:center;height:100vh;"><form action="/auth/verify" method="POST" style="text-align:center;"><h2 style="color:white;font-family:sans-serif;margin-bottom:20px;">ENTER OTP</h2><input name="email" type="hidden" value="'+req.query.email+'"><input name="otp" type="text" style="padding:20px;border-radius:15px;text-align:center;font-size:24px;font-weight:900;letter-spacing:10px;background:#1e293b;color:#38bdf8;border:none;width:260px;"><br><button type="submit" style="background:#38bdf8;padding:15px 40px;margin-top:25px;border-radius:12px;font-weight:900;cursor:pointer;border:none;">VERIFY</button></form></body>');
});
